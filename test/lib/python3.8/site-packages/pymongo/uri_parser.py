...
def parse_host(entity: str, default_port: Optional[int] = DEFAULT_PORT) -> _Address:
    ...
    if isinstance(port, str):
        if not port.isdigit():
            # Special case check for mistakes like "mongodb+srv://checkmain32:Kishore123@cluster0.jdacyq4.mongodb.net/admin?retryWrites=true&w=majority&appName=Cluster0 ".
